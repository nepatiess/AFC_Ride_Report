...
BEGIN
    ...
    ;WITH TRANSACTION_DATA AS (
        ...
        FROM TRANSACTIONS T -- TRANSCTIONS yerine TRANSACTIONS
...
/*
Geçici tablo oluþtur ve sonuçlarý kaydet
SELECT * 
INTO #TempReport 
FROM OPENROWSET('SQLNCLI', 
    'Server=(local);Trusted_Connection=yes;', 
    'EXEC SP_GENERATEREPORT ''2024-01-01'', ''2025-01-31''');
*/